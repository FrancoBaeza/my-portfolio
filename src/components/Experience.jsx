...
export default () => {
  ...
  return (
    <section className={`py-[100px] h-screen w-[1000px] flex flex-col gap-7`}>
      {/* title */}
      ...
      <div className="flex flex-row px-[100px] gap-10">
        ...
        <div className=" flex flex-col items-end">
          <div className="flex flex-row items-center my-[-4px]">
            <p
              className={` ${
                year === 2023 ? "text-base-primary" : "text-200-primary"
            ...
            <button
              ...
              className={` ${
                year === 2023 ? " bg-base-primary" : " bg-base-secondary"
          ...
          <div className="flex flex-row items-center my-[-4px]">
            <p
              className={` ${
                year === 2022 ? "text-base-primary" : "text-200-primary"
              } duration-300 font-bold font-markProBold pr-1`}
            >
              2022
            </p>
            <button
              ...
              className={` ${
                year === 2022 ? " bg-base-primary" : " bg-base-secondary"
              } h-4 w-4 rounded-full duration-300`}
            ></button>
          </div>
          ...
          <div className="flex flex-row items-center my-[-4px]">
            <p
              className={` ${
                year === 2021 ? "text-base-primary" : "text-200-primary"
              } duration-300 font-bold font-markProBold pr-1`}
            >
              2021
            </p>
            <button
              ...
              className={` ${
                year === 2021 ? " bg-base-primary" : " bg-base-secondary"
              } h-4 w-4 rounded-full duration-300`}
            ></button>
          </div>
          ...
          <div className="flex flex-row items-center my-[-4px]">
            <p
              className={` ${
                year === 2020 ? "text-base-primary" : "text-200-primary"
              } duration-300 font-bold font-markProBold pr-1`}
            >
              2020
            </p>
            <button
              ...
              className={` ${
                year === 2020 ? " bg-base-primary" : " bg-base-secondary"
              } h-4 w-4 rounded-full duration-300`}
            ></button>
          </div>
        </div>
