        ...
        >
                ...
                <div className="relative group flex justify-center">
                    <div className="relative">
                        ...
                        <img
                            ...
                            className="max-w-full max-h-[400px] object-contain rounded-lg shadow-lg border border-base-secondary/20"
                        />
            ...
            <div className="lg:w-1/2 w-full space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <h3 className="text-3xl font-markProBold text-base-primary">
                        {title}
                    </h3>
                    <p className="text-lg text-400-primary font-markPro">
                        {subtitle}
                    </p>
                </div>

                {/* Description Card */}
                <div className="bg-base-bg/50 backdrop-blur-sm border border-base-secondary/30 rounded-lg p-6 shadow-lg">
                    ...
                    <div className="flex items-start gap-3 mb-4">
                        <Icon
                            icon="user"
                            className="w-5 h-5 fill-base-secondary mt-0.5"
                        />
                        <div>
                            <span className="text-base-secondary font-markProBold text-sm">
                                My Role:
                            </span>
                            <p className="text-400-primary font-markPro text-sm">
                                {role}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-3">
                        {technologies.map((tech, index) => (
                            ...
                            >
                                <Icon
                                    icon={tech.icon}
                                    className={`w-4 h-4 ${tech.fill ? `fill-${tech.fill}` : "fill-base-secondary"}`}
                                />
